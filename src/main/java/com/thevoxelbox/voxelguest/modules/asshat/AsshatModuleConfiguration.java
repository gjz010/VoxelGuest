...
public class AsshatModuleConfiguration
{
    ...
    public void setDefaultAsshatReason(String defaultAsshatReason)
    {
    ...
    public void setBanBroadcastMsg(String banBroadcastMsg)
    {
    ...
    public void setUnbanBroadcastMsg(String unbanBroadcastMsg)
    {
    ...
    public void setKickBroadcastMsg(String kickBroadcastMsg)
    {
    ...
    public void setGagBroadcastMsg(String gagBroadcastMsg)
    {
    ...
    public void setUngagBroadcastMsg(String ungagBroadcastMsg) {
